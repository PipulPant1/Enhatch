...
const recevers ='pipul@fusemachines.com,dipesh@fusemachines.com,prerana@fusemachines.com,avishekh@fusemachines.com'
...
SendReport = async (report = []) => {
    ...
    var mailOptions = {
        to: recevers,
        subject: `TIME API Test - ${failed.length} Failed Testcases`,
        html: `<h1>Ruby Production API Result</h1> <b>Failed Test Cases:</b> <p><ul>${failed_html}</ul></p></br> <b>Passed Test Cases:</b><p><ul>${other_html}</ul></p>`,
    }
